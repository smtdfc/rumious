...
export const genComponent = async (argv) => {
  ...
  await ensureFileExists(
    componentsFilePath,
    (await readFile(templatePath)).replace(
      'ExampleComponent',
...
export const genPage = async (argv) => {
  ...
  await ensureFileExists(pagesFilePath, await readFile(templatePath))
}
