...
function bindDirective(context: RumiousRenderContext, target: HTMLElement, modifier: string, data: any): void {
  if (typeof data === "string") {
    data = context.findName(extractName(data));
  }
...
function modelDirective(context: RumiousRenderContext, target: HTMLElement, modifier: string, data: any): void {
  if (typeof data === "string") {
    data = context.findName(extractName(data));
  }
